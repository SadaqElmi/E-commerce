...
import { headPhonesProducts } from "../Backend/ProductData.js";
...
headPhonesProducts.forEach((productHeadPhones) => {
  mobileHTML += `
       <div class="group relative">
            ...
            >
              ...
              src="${productHeadPhones.image}"
              />
            </div>
            <div class="mt-4 flex justify-between">
              <div class="gap-2 flex flex-col">
                <h3 class="text-sm text-gray-700">${productHeadPhones.name}</h3>
