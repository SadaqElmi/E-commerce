...
import { shaatiProducts } from "../Backend/ProductData.js";
...
shaatiProducts.forEach((productShaati) => {
  mobileHTML += `
       <div class="group relative">
            ...
            >
              ...
              src="${productShaati.image}"
              />
            </div>
            <div class="mt-4 flex justify-between">
              <div class="gap-2 flex flex-col">
                <h3 class="text-sm text-gray-700">${productShaati.name}</h3>
