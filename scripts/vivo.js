...
import { vivoProducts } from "../Backend/ProductData.js";
...
vivoProducts.forEach((productVivo) => {
  mobileHTML += `
       <div class="group relative">
            ...
            >
              ...
              src="${productVivo.image}"
              />
            </div>
            <div class="mt-4 flex justify-between">
              <div class="gap-2 flex flex-col">
                <h3 class="text-sm text-gray-700">${productVivo.name}</h3>
