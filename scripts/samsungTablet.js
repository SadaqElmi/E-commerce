...
import { samsungTabletProduct } from "../Backend/samsungTablet.js";
...
samsungTabletProduct.forEach((productSumsungTablet) => {
  mobileHTML += `
       <div class="group relative">
            ...
            >
              ...
              src="${productSumsungTablet.image}"
              />
            </div>
            <div class="mt-4 flex justify-between">
              <div class="gap-2 flex flex-col">
                <h3 class="text-sm text-gray-700">${
                  productSumsungTablet.name
                }</h3>
