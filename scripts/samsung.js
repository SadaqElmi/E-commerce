...
samsungProduct.forEach((productSamsung) => {
  mobileHTML += `
       <div class="group relative">
            ...
            >
              ...
              src="${productSamsung.image}"
              />
            </div>
            <div class="mt-4 flex justify-between">
              <div class="gap-2 flex flex-col">
                <h3 class="text-sm text-gray-700">${productSamsung.name}</h3>
