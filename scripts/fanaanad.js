...
import { fanaanadProducts } from "../Backend/ProductData.js";
...
fanaanadProducts.forEach((productFanaanad) => {
  mobileHTML += `
       <div class="group relative">
            ...
            >
              ...
              src="${productFanaanad.image}"
              />
            </div>
            <div class="mt-4 flex justify-between">
              <div class="gap-2 flex flex-col">
                <h3 class="text-sm text-gray-700">${productFanaanad.name}</h3>
