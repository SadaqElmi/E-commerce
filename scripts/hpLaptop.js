...
import { hpLaptopProducts } from "../Backend/ProductData.js";
...
hpLaptopProducts.forEach((productHpLatop) => {
  mobileHTML += `
       <div class="group relative">
            ...
            >
              ...
              src="${productHpLatop.image}"
              />
            </div>
            <div class="mt-4 flex justify-between">
              <div class="gap-2 flex flex-col">
                <h3 class="text-sm text-gray-700">${productHpLatop.name}</h3>
