...
import { appleLaptopProducts } from "../Backend/appleLaptop.js";
...
appleLaptopProducts.forEach((productAppleLaptop) => {
  mobileHTML += `
       <div class="group relative">
            ...
            >
              ...
              src="${productAppleLaptop.image}"
              />
            </div>
            <div class="mt-4 flex justify-between">
              <div class="gap-2 flex flex-col">
                <h3 class="text-sm text-gray-700">${
                  productAppleLaptop.name
                }</h3>
