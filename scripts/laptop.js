...
import { laptopProducts } from "../Backend/ProductData.js";
...
laptopProducts.forEach((productLaptop) => {
  mobileHTML += `
       <div class="group relative">
            ...
            >
              ...
              src="${productLaptop.image}"
              />
            </div>
            <div class="mt-4 flex justify-between">
              <div class="gap-2 flex flex-col">
                <h3 class="text-sm text-gray-700">${productLaptop.name}</h3>
