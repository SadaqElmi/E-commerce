...
tshirtPrdoct.forEach((productTshirt) => {
  mobileHTML += `
       <div class="group relative">
            ...
            >
              ...
              src="${productTshirt.image}"
              />
            </div>
            <div class="mt-4 flex justify-between">
              <div class="gap-2 flex flex-col">
                <h3 class="text-sm text-gray-700">${productTshirt.name}</h3>
