...
airpodsProducts.forEach((productAirpods) => {
  mobileHTML += `
       <div class="group relative">
            ...
            >
              ...
              src="${productAirpods.image}"
              />
            </div>
            <div class="mt-4 flex justify-between">
              <div class="gap-2 flex flex-col">
                <h3 class="text-sm text-gray-700">${productAirpods.name}</h3>
